import com.kirill.vakhrushev.tradingservice.controller.ControllerException
import com.kirill.vakhrushev.tradingservice.controller.TestExchangeController
...
import com.kirill.vakhrushev.tradingservice.container.KFixedHostPortGenericContainer
...
class InMemoryAccountDaoTest {
    ...
    fun startExchange() {
        ...
        exchange = KFixedHostPortGenericContainer("vakhrushev/exchange:latest")
